...
\begin{itemize}
  ...
  \item Domain-Driven Design, Platformization, Microservices, Automation, DX
...
\begin{entrylist}
  ...
  {
    \begin{itemize}
      \item Maintained, upgraded, and monitored the fleet of core GKE clusters.
      \item Enabled all infra teams to migrate off Docker and move to containerd.
      \item Contributed to the preparation and execution of two rounds of scale tests.
      \item Helped with bootstrapping two new regions and expanding core infra globally.
      \item Improved Shopify's custom K8s controller for business-specific scaling.
      \item Carried out capacity planning and provisioning for Shopify's core infra.
      \item On-call: responded to incidents and provided support to other teams.
    \end{itemize}
    Technologies: Google Cloud, GKE, Kubernetes, Go, Terraform, etc.
  }
