...
\begin{entrylist}
  ...
  {Toronto, ON, Canada}
  {
    \begin{itemize}
      ...
      \item Researched, designed, modeled, and implemented the campaign management for Uber's advertising platform
...
% \textbf{Programming Languages:} Go, JavaScript, TypeScript, Rust, Java, C\#, C/C++ \\
